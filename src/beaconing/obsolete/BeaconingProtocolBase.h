...
#ifndef BEACONINGLAYER_BEACONINGPROTOCOLBASE_H_
#define BEACONINGLAYER_BEACONINGPROTOCOLBASE_H_
...
class BeaconingProtocol : public cSimpleModule {
...
#endif /* BEACONINGLAYER_BEACONINGPROTOCOLBASE_H_ */
