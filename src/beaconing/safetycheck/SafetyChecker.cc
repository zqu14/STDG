...
SafetyChecker::~SafetyChecker()
{
    ...
    EV << "SafetyChecker::start removing own id in node map, current size: " << nodeMap.size() << endl;
    nodeMap.erase(ownIdentifier);
    EV << "SafetyChecker::finish removing own id in node map, current size: " << nodeMap.size() << endl;
